...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<Leader>dso', function() require('dap').step_over() end, { desc = 'dap.step_over' })
      vim.keymap.set('n', '<Leader>dsi', function() require('dap').step_into() end, { desc = 'dap.step_into' })
      vim.keymap.set('n', '<Leader>dsb', function() require('dap').step_out() end, { desc = 'dap.step_out' })
      ...
      vim.keymap.set(
        ...
        { desc = 'dap.set_breakpoint with log point message' }
      )
      ...
      vim.keymap.set('n', '<Leader>dq', function() require('dapui').close() end, { desc = 'dapui.close' })
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local function client_supports_method(client, method, bufnr)
            local ok, supported = pcall(function() return client:supports_method(method, bufnr) end)
